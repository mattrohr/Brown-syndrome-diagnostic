...
This repository includes browser-based software to measure deviation in one eye. It compares locations of pupils and other facial landmarks across the eye range of motion. Current facial detection projects are inadequate because they may locate either pupil or other landmarks, but not both.
